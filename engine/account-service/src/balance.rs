...
impl Balance {
    ...
    pub fn abs(self) -> Self {
        Self { basis_points: self.basis_points.abs() }
    }
    ...
    pub fn safe_sub(self, other: Self) -> Self {
        ...
        Self { basis_points: result.max(0) }
    }
}
...
impl Add for Balance {
    ...
    fn add(self, other: Self) -> Self {
        Self { basis_points: self.basis_points + other.basis_points }
    }
}
...
impl Mul<i64> for Balance {
    ...
    fn mul(self, rhs: i64) -> Self {
        Self { basis_points: self.basis_points * rhs }
    }
}
