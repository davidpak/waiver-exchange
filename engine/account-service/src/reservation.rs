...
impl ReservationManager {
    ...
    pub fn new() -> Self {
        Self { reservations: std::collections::HashMap::new() }
    }
    ...
    pub fn get_active_reservations(&self, account_id: i64) -> Vec<&Reservation> {
        self.reservations.values().filter(|r| r.account_id == account_id && r.is_active()).collect()
    }
...
mod tests {
    ...
    fn test_reservation_expiry() {
        ...
        let reservation =
            Reservation::new(ReservationId(1), 100, Balance::from_cents(1000), 123, expires_at);
